                    ...
                    <div class="panel_general mua-panel_general">
                        ...
                        <div class="two-button-container mua-button-container">
                            <div class="two-button-a">
                                <input class="btn btn-default" onclick="document.getElementById('password').type='text';document.getElementById('password').value = '';window.location.href='#'; return (false);" type="button" value="Cancelar">
                            </div>
